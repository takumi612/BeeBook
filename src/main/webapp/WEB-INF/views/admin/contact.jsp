...
<body>
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<!-- page title area end -->
			<sf:form modelAttribute="searchModel" id = "filterForm" class="list" action="${base }/admin/contact" method="get">
				...
				<div class="single-table"
					...
					<div class="table-responsive">
						<table class="table text-center">
							...
							<tbody>
								<c:forEach items="${contactPage.getContent()}" var="contact"
									varStatus="loop">
									<tr>
										...
										<td>
											<a class="btn btn-danger" role="button"
											   href="${base }/admin/deleteContact/${contact.id }">Xóa</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
				...
				<!-- Paging -->
				<c:if test="${contactPage.totalPages >1}">
					<div class="row">
						<div class="float-end align-items-center mt-2">
							<!-- Nút Trang trước -->
							<button class="btn btn-outline-primary" onclick="navigateToPage(${contactPage.number - 1})" ${contactPage.first ? 'disabled' : ''}>
								<< Trang trước
							</button>

							<!-- Hiển thị thông tin trang hiện tại -->
							<span class="p-2">${contactPage.number + 1} / ${contactPage.totalPages}</span>

							<!-- Nút Trang sau -->
							<button class="btn btn-outline-primary" onclick="navigateToPage(${contactPage.number + 1})" ${contactPage.last ? 'disabled' : ''}>
								Trang sau >>
							</button>
						</div>
					</div>
